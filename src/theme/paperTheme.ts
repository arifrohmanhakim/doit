...
export const paperTheme = {
  ...
  colors: {
    ...
    tertiary: '#2f7d4f',
    onTertiary: '#ffffff',
    tertiaryContainer: '#d7f0df',
    onTertiaryContainer: '#12371b',
    error: '#d8294e',
    onError: '#ffffff',
    ...
    shadow: '#000000',
    scrim: '#000000',
    inverseSurface: '#253247',
    inverseOnSurface: '#f3f6fa',
    inversePrimary: '#7edc9b',
    surfaceDisabled: 'rgba(9, 18, 45, 0.12)',
    onSurfaceDisabled: 'rgba(9, 18, 45, 0.38)',
    backdrop: 'rgba(18, 33, 56, 0.4)',
    surfaceTint: '#0da837',
    elevation: {
      level0: 'transparent',
      level1: '#f5faf7',
